...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    description: `Privacy policy for ${siteName} website enquiries and document requests.`,
  };
}
    ...
    <main>
      ...
      <section className="py-14">
        <div className="prose prose-gray mx-auto max-w-4xl px-6">
          ...
          <p>Information is retained only as long as needed for commercial communication, compliance, and recordkeeping. You may request correction or deletion by contacting {contactEmail}.</p>
        </div>
      </section>
    </main>
  );
