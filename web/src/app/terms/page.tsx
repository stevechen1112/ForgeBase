...
export const metadata: Metadata = {
  ...
  description: "Terms governing the use of the NorthForge Tools website and business enquiry channels.",
};
    ...
    <main>
      ...
      <section className="py-14">
        <div className="prose prose-gray mx-auto max-w-4xl px-6">
          <p>This website is provided for product presentation, business enquiry, RFQ intake, and technical document access related to NorthForge Tools.</p>
