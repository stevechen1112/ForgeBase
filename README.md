...
| 文件 | 說明 |
|------|------|
| [FORGEBASE_DOCUMENT_AUTHORITY_INDEX_2026-08-28.md](FORGEBASE_DOCUMENT_AUTHORITY_INDEX_2026-08-28.md) | **文件權威、版本狀態與衝突判定入口** |
| [FORGEBASE_FUNCTION_MODULE_COMPLETENESS_AUDIT_2026-08-15.md](FORGEBASE_FUNCTION_MODULE_COMPLETENESS_AUDIT_2026-08-15.md) | 2026-08-28 正式環境更新版：17 模組、北極星與商用 Gate |
| [FORGEBASE_NORTH_STAR_CORE_GAP_IMPLEMENTATION_PLAN_2026-08-26.md](FORGEBASE_NORTH_STAR_CORE_GAP_IMPLEMENTATION_PLAN_2026-08-26.md) | 單一產品北極星、Build vs. Buy、實作規格與最新 production 記錄 |
| [FORGEBASE_NORTH_STAR_IMPLEMENTATION_PROGRESS_2026-08-26.md](FORGEBASE_NORTH_STAR_IMPLEMENTATION_PROGRESS_2026-08-26.md) | 北極星各批實作、測試與 code review 紀錄 |
| [FORGEBASE_INTERNAL_PRODUCTIZATION_14_BATCH_PROGRESS_2026-08-27.md](FORGEBASE_INTERNAL_PRODUCTIZATION_14_BATCH_PROGRESS_2026-08-27.md) | 14 批內部產品化與 Release Gate 證據 |
...
| [FORGEBASE_MASTER_ROADMAP.md](FORGEBASE_MASTER_ROADMAP.md) | 歷史 Leads Growth OS 五線五階段 roadmap；不再是目前總表 |
| [FORGEBASE_AI_CUSTOMER_SERVICE_DEVELOPMENT_PLAN.md](FORGEBASE_AI_CUSTOMER_SERVICE_DEVELOPMENT_PLAN.md) | 歷史 AI 業務顧問 v2 工程設計 |
