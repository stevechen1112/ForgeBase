...
class PageBriefCreate(BaseModel):
    ...
    secondary_keywords: Optional[str] = None   # JSON array
    tone: Optional[str] = Field(default=None, max_length=40)
    word_count_target: Optional[int] = Field(default=None, ge=100, le=10000)
...
class PageBriefUpdate(BaseModel):
    target_page_type: Optional[str] = Field(default=None, max_length=40)
    target_slug: Optional[str] = Field(default=None, max_length=120)
    title_draft: Optional[str] = Field(default=None, max_length=120)
    audience_persona: Optional[str] = Field(default=None, max_length=200)
    buyer_stage: Optional[str] = Field(default=None, max_length=40)
...
class ContentStrategyCreate(BaseModel):
    ...
    entity_id: Optional[uuid.UUID] = None
    brief_id: Optional[uuid.UUID] = None
    status: str = Field(default="unplanned", max_length=30)
    locale: str = Field(default="en", max_length=5)
    notes: Optional[str] = None
...
class BriefStatusTransition(BaseModel):
    """Payload for brief lifecycle transitions."""
    action: str
    # "approve" | "start" | "complete" | "publish" | "request_revision"
