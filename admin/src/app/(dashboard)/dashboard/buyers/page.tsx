...
import { ClipboardList, Eye, MailCheck, Target, TrendingUp } from "lucide-react";
...
const flow: FlowStep[] = [
  ...
  { label: "意圖評分", feature: "intent_scoring" },
...
const items: WorkspaceItem[] = [
  ...
  { title: "高意圖買家", description: "依可解釋的站內行為分數找出值得優先關注的匿名買家。", href: "/dashboard/intent", icon: Target, feature: "intent_scoring", accent: "amber" },
