...
const DASHBOARD_GROUPS: RouteGroup[] = [
  { base: "/dashboard/content/locales", label: "多語內容", parentHref: "/dashboard/content", parentLabel: "內容中心" },
  { base: "/dashboard/settings/site-copy", label: "網站文案與圖片", parentHref: "/dashboard/content", parentLabel: "內容中心" },
  { base: "/dashboard/products", label: "商品管理", entityLabel: "商品", parentHref: "/dashboard/content", parentLabel: "內容中心" },
  { base: "/dashboard/categories", label: "商品分類", entityLabel: "分類", parentHref: "/dashboard/content", parentLabel: "內容中心" },
  { base: "/dashboard/pages", label: "頁面管理", entityLabel: "頁面", parentHref: "/dashboard/content", parentLabel: "內容中心" },
  { base: "/dashboard/assets", label: "圖片與檔案", parentHref: "/dashboard/content", parentLabel: "內容中心" },
  { base: "/dashboard/applications", label: "應用場景", entityLabel: "應用場景", parentHref: "/dashboard/content", parentLabel: "內容中心" },
  { base: "/dashboard/faqs", label: "常見問題", entityLabel: "常見問題", parentHref: "/dashboard/content", parentLabel: "內容中心" },
  { base: "/dashboard/certifications", label: "認證管理", entityLabel: "認證", parentHref: "/dashboard/content", parentLabel: "內容中心" },
  { base: "/dashboard/capabilities", label: "廠能介紹", entityLabel: "廠能", parentHref: "/dashboard/content", parentLabel: "內容中心" },
  { base: "/dashboard/comparisons", label: "產品比較", entityLabel: "產品比較", parentHref: "/dashboard/content", parentLabel: "內容中心" },
  ...
  { base: "/dashboard/notifications", label: "通知中心", parentHref: "/dashboard", parentLabel: "每日營運總覽" },
  { base: "/dashboard/users", label: "團隊成員", parentHref: "/dashboard", parentLabel: "每日營運總覽" },
