...
export const WORKSPACES: Workspace[] = [
  ...
  },
  {
    ...
    label: "詢價承接",
    shortLabel: "詢價承接",
    description: "從新詢價、分派到業務接手都在同一區。",
    href: "/dashboard/workspaces/inquiries",
    icon: ClipboardList,
    accent: "amber",
    items: [
      { label: "詢價案件", description: "依權限查看、分派、接手與封存 RFQ。", href: "/dashboard/rfqs", icon: ClipboardList, keywords: ["RFQ", "詢價", "分派", "接手"] },
  ...
  },
  {
    ...
    label: "訪客與來源",
    shortLabel: "訪客與來源",
    description: "了解訪客從來源、瀏覽、對話到詢價的完整脈絡。",
    href: "/dashboard/workspaces/customers",
    icon: Users,
    accent: "blue",
    items: [
      { label: "訪客與來源總覽", description: "依序查看來源、網站互動、對話與詢價形成。", href: "/dashboard/buyers", icon: Route },
      { label: "訪客旅程", description: "查看匿名訪客的來源與網站互動歷程。", href: "/dashboard/visitors", icon: UserSearch, feature: "full_tracking" },
      { label: "AI 客服對話", description: "從訪客旅程查看網站對話與轉詢價情況。", href: "/dashboard/chats", icon: BotMessageSquare, feature: "chat_handoff" },
  ...
  },
  {
    ...
    label: "郵件回訪",
    shortLabel: "郵件回訪",
    description: "查看網站與詢價成效，對符合條件的聯絡人安排合規回訪。",
    href: "/dashboard/workspaces/buyer-followup",
    icon: Handshake,
    accent: "rose",
    roles: editors,
    items: [
      { label: "網站內容與詢價成效", description: "找出帶來探索、下載與詢價的內容。", href: "/dashboard/content-performance", icon: ChartNoAxesCombined, feature: "full_tracking" },
      { label: "回訪名單", description: "依市場與可驗證互動整理合規回訪名單。", href: "/dashboard/segments", icon: Users, feature: "audience_segments" },
      { label: "回訪安排", description: "安排第幾天提供哪些網站與產品資料。", href: "/dashboard/nurture", icon: Megaphone, feature: "nurture_email" },
