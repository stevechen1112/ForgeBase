...
export const WORKSPACES: Workspace[] = [
  { id:"today", label:"今日工作", shortLabel:"今日工作", description:"先處理今天到期、待分派與待交接的工作。", href:"/dashboard/workspaces/today", icon:LayoutDashboard, accent:"cyan", items:[{label:"營運總覽",description:"先掌握網站承接、詢價交接與今日優先事項。",href:"/dashboard",icon:Gauge,keywords:["總覽","Dashboard","首頁","晨報","KPI"]},{label:"今日待辦",description:"集中處理已指派、到期與逾期工作。",href:"/dashboard/tasks",icon:ListChecks,keywords:["工作","任務"]},{label:"通知中心",description:"查看系統與團隊需要留意的通知。",href:"/dashboard/notifications",icon:Bell}] },
